...
public class order_delete_page extends javax.swing.JFrame
{
    public order_delete_page()
    {
        initComponents();
        
        setDefaultCloseOperation(order_delete_page.DISPOSE_ON_CLOSE);
    }
    ...
    {//GEN-HEADEREND:event_btn_deleteActionPerformed
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                try
                {
                    query = "delete from `medical_store`.`sup_order` where order_id = ?";
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(order_delete_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                order_delete_page frame = new order_delete_page();
