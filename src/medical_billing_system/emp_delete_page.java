...
public class emp_delete_page extends javax.swing.JFrame
{
    public emp_delete_page()
    {
        initComponents();
        
         setDefaultCloseOperation(emp_delete_page.DISPOSE_ON_CLOSE);
    }
    ...
    {//GEN-HEADEREND:event_btn_deleteActionPerformed
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                try
                {
                      query = "delete from `medical_store`.`employee` where emp_id = ?";
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(emp_delete_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                emp_delete_page frame = new emp_delete_page();
