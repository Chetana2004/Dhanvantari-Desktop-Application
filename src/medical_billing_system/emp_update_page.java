...
public class emp_update_page extends javax.swing.JFrame
{
    public emp_update_page()
    {
        initComponents();
        
        setDefaultCloseOperation(emp_update_page.DISPOSE_ON_CLOSE);
    }
    ...
    {//GEN-HEADEREND:event_btn_updateActionPerformed
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                update_emp_form uep = new update_emp_form(Integer.parseInt(txt_id.getText()));
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(emp_update_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                emp_update_page frame = new emp_update_page();
