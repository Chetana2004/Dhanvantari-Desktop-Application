...
public class order_update_page extends javax.swing.JFrame
{
    public order_update_page()
    {
        initComponents();
        
        setDefaultCloseOperation(order_update_page.DISPOSE_ON_CLOSE);
    }
    ...
    {//GEN-HEADEREND:event_btn_updateActionPerformed
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                order_update_form ouf = new order_update_form(Integer.parseInt(txt_id.getText()));
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(order_update_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                order_update_page frame = new order_update_page();
